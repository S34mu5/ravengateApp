...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get showStandsInsteadOfGates => 'Mostrar stands en lugar de gates';

  @override
  String get showStandsInsteadOfGatesSubtitle =>
      'Cuando esté disponible, muestra el número de stand (ej: Stand 60) en lugar de la gate (ej: D2)';
  ...
  String oversizeRegistrationNotificationTitle(String itemType) =>
      'Nuevo Registro de ${itemType.toUpperCase()}';
  ...
  String oversizeRegistrationNotificationBody(
      ...
      '${count > 1 ? count : 'Un'} ${itemType.toUpperCase()}${count > 1 ? 's' : ''} ${count > 1 ? 'fueron registrados' : 'fue registrado'} para el vuelo $flightId $departureTime a $destination. Puerta $gate';
  ...
  @override
  String get photoOfElement => 'Foto del elemento';
  ...
  String get oversizeLocationOnly =>
      'Solo puedes gestionar fotos de elementos oversized cuando estés en la ubicación "Oversize".';
